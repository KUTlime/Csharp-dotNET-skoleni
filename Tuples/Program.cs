namespace Tuples
{
    ...
    Dobré vědět:
    - Když chceme převést nebo rozložit uživatelýský datový typ na kolekci řazených členů nebo členy samotné, voláme metodu Deconstruct.
    ...
    */
    class Tuples
	{
		static void Main(string[] args)
		{
			...
			(Int32, string) anonymous = (16, "a perfect square");
			...
			(Int64, string) conversion = named; // named = (Int32, string)
		...
		public static (Int32, double, string) ReturnUnnamedTuple()
		{
			return (0, 0.0, "Hello world!");
		}

		// Funkce, která vrací pojmenovaný tuple.
		public static (Int32 index, double value, string name) ReturnNamedTuple()
		{
			return (0, 0.0, "Hello world!");
		}
	}
