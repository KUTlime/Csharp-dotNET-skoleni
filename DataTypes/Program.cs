...
// Přehled aliasů zabudovaných datových typů
...
*/
    ...
    private static void UseBasicNameForMethods()
    {
        ...
        // Pokus o převedení textu z stringu do proměnné typu int (Int32).
        // Klíčové slovíčko var se přeloží jako int (Int32).
        // Opět platí výše uvedené pro interpretaci integerů.
        int.TryParse("3", out var test);
    }
}
