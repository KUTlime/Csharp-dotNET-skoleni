...
Vytvoření stringu:
- Přiřazení literálu. | = "asdfasdf"
- Konstruktoru třídy string. | new string()
- Použitím operátoru, např. + "asdfasdf" + "asdfasdfasf"
- Návratová hodnota z metody nebo vlastnosti. | str.Substring(0,5)
- Formátováním a převedením z jiných datových typů. | 5.ToString()
